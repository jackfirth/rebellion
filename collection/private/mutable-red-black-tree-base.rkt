...
(provide
 (contract-out
  ...
  [mutable-rb-node? predicate/c]
  [mutable-rb-root? predicate/c]
  [mutable-rb-root-node (-> mutable-rb-root? mutable-rb-node?)]
  [nil-leaf? predicate/c]
  [proper-mutable-rb-node? predicate/c]
  ...
  [black-node? predicate/c]
  [red-node? predicate/c]
  [root-node? predicate/c]
  [color? predicate/c]
  [red color?]
  [black color?]
  [direction? predicate/c]
